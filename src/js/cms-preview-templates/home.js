    ...
    return <div>
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="flex-ns">
              {(entry.getIn(["data", "worshipvideos"]) || []).map((vid, i) => <div key={i} style={{width:'100%'}}>
                <div style={{position: 'relative', paddingBottom: '56.25%', marginBottom: '30px', height: '0', overflow: 'hidden', maxWidth: '100%'}}>
                  <iframe
                  src={`//www.youtube.com/embed/${vid.video}`}
                  style={{position: 'absolute', top: '0', left: '0', width: '100%', height: '100%'}}
                  allowfullscreen
                  frameborder="0"
                  title={`${vid.title}`}
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <p className="mb4 mw6">{entry.getIn(["data", "sermon", "title"])}</p>
            <div className="flex-ns">
              <div style={{width:'100%'}}>
                <div style={{position: 'relative', paddingBottom: '56.25%', marginBottom: '30px', height: '0', overflow: 'hidden', maxWidth: '100%'}}>
                  <iframe
